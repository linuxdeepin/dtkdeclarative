...
#ifndef DPLATFORMTHEMEPROXY_H
#define DPLATFORMTHEMEPROXY_H
...
class DPlatformThemeProxyPrivate;
class DPlatformThemeProxy : public QObject, public DTK_CORE_NAMESPACE::DObject
{
    Q_OBJECT
