...
- Keep ComboBox window popup open during focus transfer
- Match ComboBox popup background to popup type
- Prevent startTimer warning when event dispatcher is unavailable
- Use polish for layout scheduling in Qt6
...
- Add blur radius limit to prevent shadow crash

### Changed

- Translate dtkdeclarative.ts in ru
- Break binding loop in background Loader selection
...
- Split Qt5 and Qt6 workflow steps

### Fixed

- Load icon synchronously
- Fix: prevent null pointer dereference by disconnecting textureChanged
- Clip overflow text in basic settings
...
- Unify dtk5 and dtk6 version handling

### Fixed

- Set retainWhileLoading to true for DQuickDciIconImage
...
- Refactor progress bar animation and visual effects
